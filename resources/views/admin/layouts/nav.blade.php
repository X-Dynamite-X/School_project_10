                ...
                <div class="hidden sm:ml-6 sm:block">
                    <div class="flex space-x-4">
                        ...
                        @auth
                            ...
                            @endif
                            @if (Route::has('message_index'))
                                <a href="{{ route('message_index') }}"
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button"
                                ...
                                <img class="h-8 w-8 rounded-full"
                                    src="{{ asset('imageProfile/' . Auth::user()->image) }}"id="imgAvatar2" alt="">
                            </button>
                        </div>
                        ...
                        <div id="user_menu_button"
                            ...
                            <a href="{{ route('profile_index') }}" class="block px-4 py-2 text-sm text-gray-700"
