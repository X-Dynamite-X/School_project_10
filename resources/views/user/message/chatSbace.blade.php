{{-- <div class="w-3/4 flex my_h_93 flex-col">
    <div class="p-4 border-b bg-white">
        <h2 class="text-2xl font-semibold">محادثة مع مستخدم 1</h2>
    </div>
    ...
    <div class="p-4 bg-white border-t button-0 right-0">
        <form class="flex">
            ...
            <button type="submit" class="bg-blue-500 text-white p-2 rounded-r-lg hover:bg-blue-600">إرسال</button>
        </form>
    </div>
</div> --}}
...
<div class="w-3/4 flex my_h_93 flex-col">
    ...
    <div class="flex-1  overflow-y-auto p-4 message_spase">
    ...
    <div class="p-4 bg-white border-t button-0 right-0">
        <form class="flex" id="chatForm" action="{{ route('store_ConversationController', ['conversation_id'=>$conversation->id]) }}">
            ...
            <input type="text" id="message_text" placeholder="Message..." name="message_text"
                class="flex-1 border border-gray-300 p-2 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            <button type="button" class="bg-blue-500 text-white p-2 rounded-r-lg hover:bg-blue-600 send_btn_input">send</button>
        </form>
    </div>
</div>
